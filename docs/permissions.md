...
Recover Deleted Photos version 1.2.1 targets Android 16 while keeping its scanning interface limited to Android 13 and later.
...
Version 1.2.1 does not add, remove, or broaden any manifest permissions.
...
Version 1.2.1 adds a compact Privacy Policy link below the Home footer. It opens a Material dialog inside the app and does not require a browser, another screen, or Internet permission.
...
These changes are intentionally deferred and are not part of version 1.2.1.
